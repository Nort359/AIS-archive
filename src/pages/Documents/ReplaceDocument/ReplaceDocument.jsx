...
class ReplaceDocument extends AForm {
    ...
    addDocument(event, user, currentDocument, expansion) {
                        ...
                        <div className='form_container'>
                            <Form header={ 'Замена документа' }>
                                ...
                                <div className='registration__button_container'>
                                    ...
                                    <Button type='button' onClick={ event => this.addDocument(event, user, currentDocument, expansion) }>Заменить</Button>
                                </div>
