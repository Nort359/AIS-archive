...
CREATE TABLE `user` (
  ...
  `email_days` smallint(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `user` VALUES("1", "Просвиркин", "Максим", "Васильевич", "img/user_photos/prosvirkin-maksim-vasil_evich__HQEQRpyWCq445.jpg", "nort359@gmail.com", "$2y$10$qgKtwHBv17k9ljRLIskTYeW3NcJdAU7Z9o0jChukwn9yx3zJL5Chu", "1", "1", "1", "0"),
("3", "Анисимов", "Евгений", "Андреевич", "img/user_photos/anisimov-evgeniy-andreevich__Stas.jpg", "mclaren@gmail.com", "$2y$10$BbgMRHxZWxTP2P6PUf304.K9zqMql3DvubPkabe5hDeAmWbl3gEhm", "1", "3", "2", "0"),
("5", "Жуков", "Сергей", "Михайлович", "img/no-profile-photo.jpg", "AkS-LH@yandex.ru", "$2y$10$8q9wJUhjPJITJFDNk9prIez9bdQZcTv6ZDkQEZ6f0Mj.uKnVQ8WQi", "9", "3", "0", "0"),
("6", "Иванов", "Иван", "Иванович", "img/no-profile-photo.jpg", "Ivanov@gmail.com", "$2y$10$RuFwM18OsJdO66txiWKoU.scqX2vxOuAlt4uRY30iGHyZzMOahhPW", "1", "3", "0", NULL);
...
("3", "Приказ №18-2", "Мой новый приказ", "2017-06-21", "2017-06-30", "2017-06-15", "prosvirkin-maksim-vasil_evich__149805559017-06-17 prosvirkin m.v. poyasnitel_naya zapiska k diplomnomu proektu.docx", "2", "1||", "1", "8"),
...
("6", "Документ СИТ-87-90", "Это новый документ в СИТ", "2017-06-21", "2017-06-28", "2017-06-21", "ivanov-ivan-ivanovich__149806977417-06-17 prosvirkin m.v. poyasnitel_naya zapiska k diplomnomu proektu _ kopiya.docx", "0", "6||", "0", "0"),
("7", "Новый приказ в СИТ-98", "Наш новый приказ", "2017-06-21", "2017-08-17", "2017-06-21", "prosvirkin-maksim-vasil_evich__149807008319-06-17 prosvirkin m.v. poyasnitel_naya zapiska k diplomnomu proektu1.docx", "2", "1||", "0", "0"),
("8", "Приказ №18-3", "Мой новый приказ", "2017-06-21", "2017-06-30", "2017-06-15", "prosvirkin-maksim-vasil_evich__149807025117-06-17 prosvirkin m.v. poyasnitel_naya zapiska k diplomnomu proektu _ kopiya.docx", "2", "1||", "0", "3");
...
INSERT INTO `notification` VALUES("38", "Дата пересмотра близка", "До даты пересмотра Вашего документа — \"Приказ №18-2\" осталось  меньше 10 дней! Вам нужно срочно пересмотреть этот документ", "2017-06-21", "3", "1", "1", NULL);
