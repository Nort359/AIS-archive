...
export const getDepartment = () => dispatch => {
    axios.get('/api/admin/department/department-get.php')
...
export const getCurrentDepartment = department => dispatch => {
    axios.post('/api/admin/department/department-get-current.php', querystring.stringify(department))
        .then(response => response.data)
...
export const deleteDepartment = department => dispatch => {
    axios.post('/api/admin/department/department-delete.php', querystring.stringify(department))
        .then(response => response.data)
        .then(answer => {
            if (answer === 'Ok') {
                dispatch({
